...
# Prefer credentials from settings.toml. If not present, these fallback
# values can be edited directly in this file.
...
def run_server():
    ...
    while True:
        print(f'[{method_name}] Starting HTTP server example')
    # connect_wifi()
...
# run_server()
while True:
    print(f'Starting HTTP server example')